(function () {
  "use strict";
  var n = function () {
    var n = "ABCDEFGHIJKLMNOPQRSTUVWXYZÁÉÍÓÚ",
      r = [
        "horizontal",
        "horizontalBack",
        "vertical",
      ...
      i = function (n, r) {
        var t,
          ...
          e,
          i = [];
        for (t = 0; t < r.height; t++) for (i.push([]), o = 0; o < r.width; o++) i[t].push("");
    ...
    return {
      ...
      solve: function (n, t) {
        for (
          var o = { height: n.length, width: n[0].length, orientations: r, preferOverlap: !0 },
            e = [],
            i = [],
            a = 0,
            u = t.length;
